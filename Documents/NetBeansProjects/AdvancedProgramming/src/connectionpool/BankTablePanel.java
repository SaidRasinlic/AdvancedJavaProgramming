...
public class BankTablePanel extends JPanel {
    ...
    String URL = "jdbc:mysql://localhost/banksystemdata";
    String USERNAME = "said";
    String PASSWORD = "StarBoyG";
    //connection pool -> 10 connection objekata        //connection pool -> 10 connection objekata
    ...
    public BankTablePanel() {
        ...
        try {
            ...
            BankDao bankDao = new BankDao(connectionPool);
